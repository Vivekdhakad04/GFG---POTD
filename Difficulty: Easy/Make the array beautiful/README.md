<h2><a href="https://www.geeksforgeeks.org/problems/make-the-array-beautiful--170647/1?_gl=1*66zq5v*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwzqXQBhD2ARIsAKrIeU904vubBe6aArQoA2_CZpKZaNk0JjqoAsRs4wxeExmotcE0S7s1E1UaAn9_EALw_wcB&gbraid=0AAAAAC9yBkAlLbrZZXXipT7-gj1iYXC0I">Make the array beautiful</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array of negative and non-negative integers. You need to make the array beautiful.</span></p>
<ul>
